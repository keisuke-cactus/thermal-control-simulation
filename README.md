...
<p align="center">
<img src="images/fig4_thermal_compensation_block_diagram.png" width="700">
</p>

<p align="center">
<b>図4. 熱干渉補償を適用した3ゾーン熱モデルのブロック線図</b>
</p>
...
<p align="center">
<img src="images/fig11_temperature_response_comparison_zoom.png" width="700">
</p>

<p align="center">
<b>図11. 外乱印加後の温度応答比較</b>
</p>
...
<p align="center">
<img src="images/fig2_thermal_block_diagram.png" width="700">
</p>

<p align="center">
<b>図2. 3ゾーン熱モデルのブロック線図</b>
</p>
...
<p align="center">
<img src="images/fig3_pid_block_diagram.png" width="700">
</p>

<p align="center">
<b>図3. PID制御のみを適用した3ゾーン熱モデルのブロック線図</b>
</p>
...
<p align="center">
<img src="images/fig5_pid_control_temperature_response.png" width="700">
</p>
...
<p align="center">
<img src="images/fig6_pid_heater_output.png" width="700">
</p>

<p align="center">
<b>図6. PID制御時のヒーター出力</b>
</p>
...
<p align="center">
<img src="images/fig7_pid_disturbance_temperature_response.png" width="700">
</p>

<p align="center">
<b>図7. Zone2外乱印加時の温度応答（PID制御）</b>
</p>

<p align="center">
<img src="images/fig8_pid_disturbance_heater_output.png" width="700">
</p>

<p align="center">
<b>図8. Zone2外乱印加時のヒーター出力（PID制御）</b>
</p>
...
<p align="center">
<img src="images/fig9_pid_compensation_temperature_response.png" width="700">
</p>

<p align="center">
<b>図9. 熱干渉補償適用時の温度応答</b>
</p>

<p align="center">
<img src="images/fig10_pid_compensation_heater_output.png" width="700">
</p>

<p align="center">
<b>図10. 熱干渉補償適用時のヒーター出力</b>
</p>
...
<p align="center">
<b>図11. 外乱印加時の温度応答比較</b>
</p>

<p align="center">
<img src="images/fig12_heater_output_comparison_zoom.png" width="700">
</p>

<p align="center">
<b>図12. 外乱印加時のヒーター出力比較</b>
</p>
...
```bash
git clone https://github.com/keisuke-cactus/thermal-control-simulation.git
cd thermal-control-simulation
```
...
Run each simulation script according to the desired analysis.

```bash
# Basic temperature response
python pid_control_simulation.py

# Disturbance response without thermal compensation
python pid_disturbance_simulation.py

# Disturbance response with thermal compensation
python pid_with_compensation_simulation.py

# Comparison between PID control and thermal compensation
python compare_pid_vs_compensation.py

# Evaluation of compensation gain B
python evaluate_compensation_gain.py
```

Generated figures are automatically saved in the `images/` directory.
...
│
├── pid_control_simulation.py             # Basic PID control
├── pid_disturbance_simulation.py         # PID with disturbance
├── pid_with_compensation_simulation.py   # PID with thermal compensation
├── compare_pid_vs_compensation.py        # Comparison of control methods
├── evaluate_compensation_gain.py         # Compensation gain evaluation
│
├── README.md
├── requirements.txt
└── .gitignore
...
GitHub: https://github.com/keisuke-cactus

This repository was developed as a portfolio project to demonstrate thermal system modeling, control engineering, and Python-based numerical simulation.